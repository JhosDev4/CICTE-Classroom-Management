<?php
session_start();
if (isset($_SESSION['admin_id']) && $_SESSION['role'] === 'Admin' && isset($_GET['room_id'])) {
...
<div class="container mt-5">
    <a href="schedule-view.php" class="btn btn-dark mb-3">← Back to Room View</a>
    <h3>Schedule for Room: <?= htmlspecialchars($room['room_name']) ?></h3>
