...
if (isset($_SESSION['admin_id']) && isset($_SESSION['role'])) {
    if ($_SESSION['role'] == 'Admin') {
        ...
        if (isset($_POST['fname'])      &&
            ...
            //Validation using correct variables
            if (empty($fname)) {
                ...
                $sql = "UPDATE teachers SET
                        ...
                        phone_number = ?, qualification = ?, gender = ?, 
                        email_address = ?, section=?
                        WHERE teacher_id=?";

                $stmt = $conn->prepare($sql);
                $stmt->execute([$uname,$fname, $lname, $subjects, $grades, $address, 
                $employee_number, $date_of_birth, $phone_number, $qualification, $gender,
                $email_address, $sections,$teacher_id]);
