...
session_start();
    if (isset($_SESSION['admin_id']) && $_SESSION['role'] == 'Admin') {
        ...
        // Fetch schedules for BSCpE (assuming 'course' column contains course name like 'BSCpE')
        $course = 'BSCpE';
    if (isset($_GET['year_level']) && in_array($_GET['year_level'], ['1', '2', '3', '4'])) {
        $year_level = $_GET['year_level'];
        $sections = getSchedulesByCourseAndYear($conn, $course, $year_level);
    } else {
        $sections = getSchedulesByCourse($conn, $course);// Custom function to filter by course
    }
?>
...
<head>
    ...
    <title>BSCpE Instructor List</title>
...
<div class="container mt-5">
    ...
    <?php } else { ?>
        <div class="alert alert-info mt-5" role="alert">No BSCpE schedules found!</div>
    <?php } ?>
</div>
